        ...
        <Slider {...settings} className="flex gap-2">
          ...
          <div className="comentator2">
            ...
            <p>
              ...
              straightforward, and the car was ready on time. The only minor
              issue was that the GPS was a bit outdated, but otherwise,
              everything was excellent. I would rent from them again.
            </p>
          </div>
          <div className="comentator3">
            ...
            <p>
              ...
              pristine condition and drove like a dream. The customer service
              was top-notch, and they even offered me a free upgrade. I couldn’t
          ...
          <div className="comentator4">
            ...
            <p>
              ...
              that the return location was a bit hard to find, but overall, a
              very positive experience. Will rent again.
            </p>
          </div>
          <div className="comentator5">
            ...
            <p>
              VCS Rentals made my trip to the city so much easier. The staff
              were friendly and efficient, and the car was in excellent
              condition. The rates were also very reasonable. I’ll definitely
              choose them for my next trip.
            </p>
          </div>
          <div className="comentator6">
            ...
            <p>
              ...
              in perfect condition and made my business trip hassle-free. I
          ...
          <div className="comentator7">
            ...
            <h3>Emily Carter</h3>
            <p>
              VCS Rentals provided excellent service from start to finish. The
              car was clean, modern, and exactly what I needed for my family
              vacation. The staff were courteous and helpful. I’ll definitely be
          ...
          <div className="comentator8">
            ...
            <p>
              ...
              their outstanding service and quality vehicles. The car was in
              great shape, and the rental process was quick and efficient.
          ...
          <div className="comentator9">
            ...
            <p>
              ...
              accommodating. I’m very pleased with the service and will
              definitely rent from them again in the future.
            </p>
          </div>
          <div className="comentator10">
            ...
            <p>
              ...
              efficient, making the entire process seamless. I will definitely
              use VCS Rentals again for my next trip.
            </p>
          </div>
        </Slider>
      </div>
