...
const handleUpdate = async (e) => {
  ...
  try{
    ...
    await axios.patch(`http://localhost:3000/api/users/${id}`,editData)
...
const handleInputChange =  (e) => {
  ...
  setEditData({...editData, email: laikinasEmail, username: laikinasUsername})
  ...
  <div className="entry-details">
   ...
   <h2>ID:{entry._id}</h2>
    ...
    <form  className='add-form' onSubmit={handleUpdate} >
     ...
     <input ref={usernameRef} type="text" onChange={handleInputChange}  placeholder={entry.username} /> 
     <label>Set email.</label>
     <input ref={emailRef} type="email" onChange={handleInputChange} placeholder={entry.email} />
